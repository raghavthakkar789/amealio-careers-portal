        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/culture" className="text-gray-300 hover:text-white transition-colors">
                  Company Culture
                </a>
              </li>
              <li>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">careers@amealio.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">www.amealio.com</span>
              </div>
            </div>
          </motion.div>
        </div>
